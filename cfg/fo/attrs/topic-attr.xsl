...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:attribute-set name="topic.title" use-attribute-sets="common.title common.border__bottom">
        ...
        <xsl:attribute name="margin-left">1.45em</xsl:attribute>
 ...
 -->
    <!-- viagonale 2024-03-05 start-indent 1.45em -->
    ...
    <!-- <xsl:attribute-set name="topic.title__content">
        <xsl:attribute name="line-height">100%</xsl:attribute>
        <xsl:attribute name="border-start-width">50pt</xsl:attribute>
        <xsl:attribute name="border-end-width">0pt</xsl:attribute>
        <xsl:attribute name="start-indent">1.45em</xsl:attribute>
        <xsl:attribute name="keep-with-next.within-column">always</xsl:attribute>
        <xsl:attribute name="border-before-width">50pt</xsl:attribute>
    </xsl:attribute-set> -->

    <!-- diaganale 2024-11-10: start-indent 1.6em -->
    ...
    <xsl:attribute-set name="topic.topic.title" use-attribute-sets="common.title common.border__bottom">
        ...
        <!-- <xsl:attribute name="start-indent">1.6em</xsl:attribute> -->
        <xsl:attribute name="keep-with-next.within-column">always</xsl:attribute>
    </xsl:attribute-set>
