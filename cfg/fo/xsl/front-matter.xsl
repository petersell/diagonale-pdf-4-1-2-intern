...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="createFrontCoverContents">
    <fo:block xsl:use-attribute-sets="__frontmatter__owner">Andreas Petersell</fo:block>
    
    <fo:block-container absolute-position="absolute"
          top="5cm" left="7.5cm" width="21cm" height="29.7cm" background-repeat="no-repeat"
          background-image="Customization/OpenTopic/common/artwork/diagonale-plain.svg">
          <fo:block/>
    </fo:block-container>
